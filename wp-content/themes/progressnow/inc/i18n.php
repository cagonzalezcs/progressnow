...
function progressnow_i18n_strings() {
	return array(
		...
		'cal_ics'             => 'iCal / .ics',
		// Calendar — toolbar + compact day agenda + grouped list (openspec calendar-mobile-day-agenda).
		'cal_prev'            => 'Previous month',
		'cal_next'            => 'Next month',
		'cal_loading'         => 'Loading events…',
		'cal_retry'           => 'Retry',
		'cal_tap_hint'        => 'Tap a day to see what’s happening.',
		'cal_day_region'      => 'Events on selected day',
		'cal_no_events'       => 'No events',
		'cal_event_count_one' => '{n} event',
		'cal_event_count_other' => '{n} events',
		'cal_day_empty'       => 'Nothing scheduled on this day. Days with a ● have events.',
		'cal_jump_next'       => 'Jump to next event · {date}',
		'cal_see_month_list'  => 'See the whole month as a list →',
		'cal_list_summary_one' => '{n} event in {month}',
		'cal_list_summary_other' => '{n} events in {month}',
		'cal_show_past'       => 'Show {n} past',
		'cal_hide_past'       => 'Hide past events',
		'cal_today_tag'       => 'TODAY',
		'event_rsvp'          => 'RSVP',
