...
if ( function_exists( 'pll_set_post_language' ) && function_exists( 'pll_save_post_translations' ) ) {
	...
	progressnow_seed_string_translations( 'es', array(
		...
		// Calendar toolbar + empty month + subscribe strip (the /site strings map had these in English on /es/).
		'Event calendar'         => 'Calendario de eventos',
		'Month'                  => 'Mes',
		'List'                   => 'Lista',
		'Filter:'                => 'Filtrar:',
		'All events'             => 'Todos los eventos',
		'Nothing scheduled this month' => 'Nada programado este mes',
		'Check the next month or subscribe below and never miss one.' => 'Mira el próximo mes o suscríbete abajo y no te pierdas ninguno.',
		'Subscribe to the calendar' => 'Suscríbete al calendario',
		'Add every meeting and action to your own calendar automatically.' => 'Añade cada reunión y acción a tu propio calendario automáticamente.',
		// Calendar island — toolbar, compact day agenda, grouped list (openspec calendar-mobile-day-agenda).
		'Previous month'         => 'Mes anterior',
		'Next month'             => 'Mes siguiente',
		'Loading events…'        => 'Cargando eventos…',
		'Retry'                  => 'Reintentar',
		'Tap a day to see what’s happening.' => 'Toca un día para ver qué hay.',
		'Events on selected day' => 'Eventos del día seleccionado',
		'No events'              => 'Sin eventos',
		'{n} event'              => '{n} evento',
		'{n} events'             => '{n} eventos',
		'Nothing scheduled on this day. Days with a ● have events.' => 'No hay nada programado este día. Los días con ● tienen eventos.',
		'Jump to next event · {date}' => 'Ir al próximo evento · {date}',
		'See the whole month as a list →' => 'Ver todo el mes como lista →',
		'{n} event in {month}'   => '{n} evento en {month}',
		'{n} events in {month}'  => '{n} eventos en {month}',
		'Show {n} past'          => 'Mostrar {n} pasados',
