    ...
    >
      <div className="mx-auto flex max-w-[1200px] flex-col items-start gap-4 md:flex-row md:flex-wrap md:items-center md:justify-between md:gap-8">
        <div className="flex max-w-[56ch] flex-col gap-2">
          <h2
            className="m-0 font-display text-[1.2rem] font-normal md:text-[1.4rem]"
            data-testid="calendar-subscribe-title"
          >
            {title}
          </h2>
          <p
            className="m-0 text-[0.98rem] leading-[1.55] text-muted-on-ink md:text-[1.05rem]"
            data-testid="calendar-subscribe-lede"
          >
            {lede}
          </p>
        </div>
