...
export function BlockA11yNote({
  ...
  return (
    <aside
      data-testid="block-a11y-note"
      className="block-a11y-note flex w-full flex-col gap-2 rounded-[16px] border-l-[5px] border-brand bg-alt px-[22px] py-5 md:rounded-[20px] md:border-l-[6px] md:px-[30px] md:py-[26px]"
    >
      <div
        className="text-[0.92rem] font-extrabold uppercase tracking-[0.04em] text-brand md:text-base"
        data-testid="block-a11y-note-heading"
      >
        {heading}
      </div>
