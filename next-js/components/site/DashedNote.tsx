...
export function DashedNote({
  ...
  return (
    ...
    >
      <div className="text-[0.95rem] font-extrabold uppercase tracking-[0.04em] text-ink lg:text-base">
        {heading}
      </div>
      <div className="text-[0.95rem] leading-[1.55] text-text-body [&_a]:font-bold [&_a]:text-accent [&_a]:no-underline hover:[&_a]:underline hover:[&_a]:underline-offset-4 [&_p]:m-0 lg:text-[0.98rem]">
        {children}
      </div>
    </div>
  );
