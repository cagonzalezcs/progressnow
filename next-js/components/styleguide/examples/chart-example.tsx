...
function ChartBarExample() {
  // The registry example reads the design-system preset from the URL; this app is fixed on radix-nova (rounded).
        ...
        <CardContent>
          <ChartContainer config={barChartConfig}>
            <BarChart accessibilityLayer data={barChartData}>
              ...
              <Bar dataKey="desktop" fill="var(--color-desktop)" radius={isRounded ? 4 : 0} />
              <Bar dataKey="mobile" fill="var(--color-mobile)" radius={isRounded ? 4 : 0} />
            </BarChart>
          </ChartContainer>
        </CardContent>
