# interior-presentation Specification

## Purpose
Presentation contract for the interior templates (About, Get Involved, generic page: page header with breadcrumb, mission band, article + sticky sidebar, committee cards, FAQ disclosure rows, subscribe strip) and the 404 page on the Progress Now v4 brand system, in both renderers (theme Twig shell + Nuxt site). Section content and visibility live in editable-page-sections; strings in internationalization.
