# next-deployment Specification

## Purpose
Deployment contract for the Next.js frontend: the standalone build and container image, the environment variables validated at startup, security headers and CSP, image and asset caching policy, portability across hosting paths, observability, and the operator documentation that ships with it.
