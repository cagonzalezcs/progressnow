...
## Purpose
Test contract for the Next.js frontend: unit, component, contract-fixture, and drift tests, the fixture-backed mock API that runs the whole site without WordPress, and the functional e2e and accessibility Playwright suites the CI job runs against the production build.
