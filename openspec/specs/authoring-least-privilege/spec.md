# authoring-least-privilege Specification

## Purpose
Role and content-sanitization controls that keep executable markup out of stored content regardless of user capability, remove `unfiltered_html` from every role, and document the least-privilege role model for the WordPress authoring backend.
## Requirements
