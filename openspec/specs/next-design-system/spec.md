# next-design-system Specification

## Purpose
Design-system contract for the Next.js frontend: the theme's stylesheet, zod contracts, and category registry carried as drift-tested byte-identical copies, Tailwind v4 configured CSS-first, shadcn/ui primitives mapped onto the shared tokens, and the styleguide as the visual-parity surface.
