...
- **Licensing + community files:** root `LICENSE` (MIT) and matching `license` fields in `style.css`, `composer.json`, and both `package.json`; root `README.md`, `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, `SECURITY.md`; theme `package.json` renamed from `vite-project`.
