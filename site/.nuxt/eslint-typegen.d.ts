...
/* eslint-typegen-hash: 9CQ4eT_SCx0LaIQJ-SlOGYARARdCGV79g2yWpxQmNEg */
...
declare module 'eslint-flat-config-utils' {
  interface DefaultConfigNamesMap {
    ...
    'vuejs-accessibility:setup:base'?: true,
    'vuejs-accessibility:setup:with-files-rules-and-parser'?: true,
