...
import { getCurrentScope, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated, createApp, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, hasInjectionContext, inject, defineComponent, computed, mergeProps, withCtx, toRef, shallowRef, h, defineAsyncComponent, isVNode, createCommentVNode, isReadonly, Suspense, nextTick, Fragment, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { c as createError, n as defu, $ as $fetch, o as hasProtocol, i as joinURL, w as withQuery, p as sanitizeStatusCode, q as parseURL, e as encodePath, t as decodePath } from '../nitro/nitro.mjs';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate, ssrRenderClass } from 'vue/server-renderer';
...
function hashMarginTop(selector) {
	try {
		const el = (void 0).querySelector(selector);
		if (el) return (Number.parseFloat(getComputedStyle(el).scrollMarginTop) || 0) + (Number.parseFloat(getComputedStyle((void 0).documentElement).scrollPaddingTop) || 0);
	} catch {}
	return 0;
}
//#endregion
...
//#endregion
//#region app/middleware/freshness.global.ts
var freshness_global_default = /* @__PURE__ */ defineNuxtRouteMiddleware(async (_to, from) => {});
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Froutes_default = [{
	name: "slug",
	path: "/:slug(.*)*",
	component: () => import('../build/_...slug_-BvMl6F6Y.mjs')
}];
//#endregion
...
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Flayouts_default = { default: defineAsyncComponent(() => import('../build/default-C_Sd-9UA.mjs').then((m) => m.default || m)) };
//#endregion
...
//#endregion
//#region app/components/routes/StarGlyph.vue?vue&type=script&setup=true&lang.ts
var StarGlyph_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "StarGlyph",
	__ssrInlineRender: true,
	props: {
		kind: { default: "star" },
		class: { default: "w-[50px]" }
	},
	setup(__props) {
		return (_ctx, _push, _parent, _attrs) => {
			if (__props.kind === "sparkle") _push(`<svg${ssrRenderAttrs(mergeProps({
				"aria-hidden": "true",
				focusable: "false",
				viewBox: "0 0 41.72 45.56",
				class: [_ctx.$props.class, "h-auto"]
			}, _attrs))}><polygon fill="currentColor" points="25.85 16.6 41.72 23.74 27.94 27.33 22.78 45.56 15.78 30.31 0 38.44 9.45 22.37 3.27 13.79 14.39 13.86 28.2 0 25.85 16.6"></polygon></svg>`);
			else if (__props.kind === "star-notch") _push(`<svg${ssrRenderAttrs(mergeProps({
				"aria-hidden": "true",
				focusable: "false",
				viewBox: "0 0 57.51 74.26",
				class: [_ctx.$props.class, "h-auto"]
			}, _attrs))}><path fill="currentColor" d="M55.15,15.92l-13.04,15.8,15.39,26.17c-.36,1.11-19.46-8.38-26.05-11.08l-9.81,27.46-5.9-27.81c-1.08-1.43-15.75-2.83-15.75-2.83l14.46-13.81c.72-3.79.21-30.41.47-29.81l14.1,23.46c.56.51,27.21-8.76,26.12-7.55Z"></path></svg>`);
			else _push(`<svg${ssrRenderAttrs(mergeProps({
				"aria-hidden": "true",
				focusable: "false",
				viewBox: "0 0 61.68 70.82",
				class: [_ctx.$props.class, "h-auto"]
			}, _attrs))}><path fill="currentColor" d="M61.62,30.6l-18.24,9.31,3.72,30.13c-.77.87-14.53-15.43-19.5-20.52l-19.92,21.3,5.64-27.87c-.42-1.74-13.32-8.86-13.32-8.86l18.75-6.92C20.92,23.99,31.04-.65,31.03.01l3.62,27.13c.31.69,28.45,2.78,26.97,3.46Z"></path></svg>`);
		};
	}
});
//#endregion
//#region app/components/routes/StarGlyph.vue
var _sfc_setup$2 = StarGlyph_vue_vue_type_script_setup_true_lang_default.setup;
StarGlyph_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/routes/StarGlyph.vue");
	return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
var StarGlyph_default = StarGlyph_vue_vue_type_script_setup_true_lang_default;
//#endregion
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<section${ssrRenderAttrs(mergeProps({
				class: "not-found relative flex min-h-[70vh] items-center overflow-hidden bg-brand px-6 pb-24 pt-20 font-sans text-white md:px-10 md:pb-[110px] md:pt-[100px] xl:px-6 xl:pb-[120px] xl:pt-[110px]",
				"data-tone": "blue"
			}, _attrs))}>`);
			...
			_push(`<div class="relative mx-auto flex w-full max-w-[720px] flex-col items-center gap-5 text-center md:max-w-[620px] md:gap-6 xl:max-w-[720px] xl:gap-[26px]"><div aria-hidden="true" class="headline-shadow-sm font-display text-[5.5rem] leading-none md:text-[7.5rem] xl:text-[clamp(5rem,14vw,10rem)]">${ssrInterpolate(status.value)}</div><h1 class="m-0 max-w-[20ch] font-display text-[1.25rem] font-normal uppercase leading-[1.25] md:max-w-none md:text-[1.6rem] md:leading-[1.2] xl:text-[clamp(1.4rem,2.8vw,2rem)]">${ssrInterpolate(isNotFound.value ? "This page got organized out of existence" : "Something went wrong")}</h1><p class="m-0 max-w-[34ch] text-[1.02rem] font-semibold leading-[1.5] md:max-w-[42ch] md:text-[1.12rem] xl:max-w-[44ch] xl:text-[1.2rem]">${ssrInterpolate(isNotFound.value ? "The page you’re looking for isn’t here — it may have moved, or the link may be broken." : "We couldn’t load this page. Reloading usually fixes it.")}</p><div class="flex flex-wrap justify-center gap-3 md:gap-3.5"><a href="/" data-native-nav class="${ssrRenderClass(PILL_WHITE)}">Back home</a>`);
			if (isNotFound.value) _push(`<a href="/calendar/" data-native-nav class="${ssrRenderClass(PILL_OUTLINE)}">See the calendar</a>`);
			else _push(`<button type="button" class="${ssrRenderClass(["cursor-pointer", PILL_OUTLINE])}">Try again</button>`);
...
export { StarGlyph_default as S, useRoute$1 as a, useRuntimeConfig as b, useNuxtApp as c, appDiagnostics as d, sanitizeTag as e, asyncDataDefaults as f, docsBase as g, createError$1 as h, entry as i, prodReporters as p, stateDiagnostics as s, tryUseNuxtApp as t, useHead$1 as u };
